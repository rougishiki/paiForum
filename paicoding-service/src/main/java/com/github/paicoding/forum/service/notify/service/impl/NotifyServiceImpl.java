...
public class NotifyServiceImpl implements NotifyService {
    ...
    public void saveArticleNotify(UserFootDO foot, NotifyTypeEnum notifyTypeEnum) {
        NotifyMsgDO msg = new NotifyMsgDO().setRelatedId(foot.getDocumentId())//文章id/评论id
                .setNotifyUserId(foot.getDocumentUserId())//作者id
                .setOperateUserId(foot.getUserId())//用户id
                .setType(notifyTypeEnum.getType() )//类型：点赞?评论?
                .setState(NotifyStatEnum.UNREAD.getStat())//状态：未读
                .setMsg("");
